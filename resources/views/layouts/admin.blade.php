...
<html>
  <head>
    ...
    <title>DioVentas | www.cdio.com</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="/" class="logo">
          ...
          <span class="logo-mini"><b>Dio</b>V</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>DioVentas</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Ruben Dario Granados</span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      www.SolucionesDio.com - Desarrollando Software
                      <small>www.youtube.com/cdiopersonalizados</small>
                    </p>
                  </li>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2016-2025 <a href="www.cdio.com">Cdio</a>.</strong> All rights reserved.
      </footer>
